...
public class ManageGoodEditFrame extends JFrame {
...
//			public void run() {
//				try {
//					ManageGoodEditFrame window = new ManageGoodEditFrame();
...
//	}
	 ...
	 */
	public ManageGoodEditFrame(final Integer id) {
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				good.setGoodId(id);
				good.setGoodUseable(new Integer(textField.getText()));
				manageViewController.changeGoodState(good);
				ManageGoodEditFrame.this.setVisible(false);
			}
		});
